...
```{r stations_exploratory_plot,fig.height = 5,message = FALSE, warning = FALSE, results='hide',out.width = '75%',fig.align = 'center', fig.cap = 'Figure 1. Locations of New Jersey Transit stations'}
## use line; rid of axis titles
...
```{r ReadbackgroundPic, echo=FALSE,fig.height = 1,out.width = '75%',fig.align = 'center', fig.cap = 'Figure 3. Use case of our predicting algorithm'}
...
kable(trainIDforWholeTrip,align = 'c',caption = '<center>Table 1. A trainID for a whole trip</center>')%>%
...
```{r lag Variables plot, message=FALSE, warning=FALSE, results='hide', fig.cap = 'Figure 7. Delays as a function of time lag features'}
...
```{r Weather Variables plot, message=FALSE, warning=FALSE, results='hide', fig.cap = 'Figure 8. Delays as a function of weather features'}
...
```{r other features plot, message=FALSE, warning=FALSE, results='hide', fig.cap = 'Figure 9. Delays as functions of the other features'}
...
The baseline model an Ordinary Least Square linear model that takes *delay length* as the dependent variable and four categories of predictors:
