...
```{r logit results plot, message=FALSE, fig.cap = 'Figure 15. Distribution of predicted delay possibilities by observed outcome', warning=FALSE,fig.height=4,out.width='50%',fig.align='center'}
...
```{r MAE by station by week, message=FALSE, warning=FALSE,fig.height = 5,out.width='75%',fig.align='center'}
...
```{r MAE by line2,message=FALSE, warning=FALSE,fig.height = 5,out.width = '75%',fig.align = 'center'}
byLine %>%
  ggplot() +
  geom_sf(data = st_union(njCounties),
          color='black', size=1, fill = NA)+
